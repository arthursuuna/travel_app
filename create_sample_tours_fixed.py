"""
Sample data creator for tours - FIXED VERSION
        ...
        tours_data = [
            {
                ...
                "duration_days": 7,
                "max_participants": 12,
                "category_id": adventure_cat.id if adventure_cat else 1,
            ...
            },
            {
                ...
                "duration_days": 4,
                "max_participants": 8,
                "category_id": safari_cat.id if safari_cat else 1,
            ...
            },
            {
                ...
                "duration_days": 1,
                "max_participants": 20,
                "category_id": cultural_cat.id if cultural_cat else 1,
            ...
            },
            {
                ...
                "duration_days": 3,
                "max_participants": 15,
                "category_id": beach_cat.id if beach_cat else 1,
                "image_url": "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "is_active": True,
                "available_from": date(2024, 1, 1),
                "available_to": date(2024, 12, 31),
